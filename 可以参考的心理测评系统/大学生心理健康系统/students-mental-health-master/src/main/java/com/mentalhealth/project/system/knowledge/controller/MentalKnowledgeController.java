...
//            UserRole userRole =userService.findOneByUserId(ShiroUtils.getUserId());
...
//     * 上一篇
//     */
//    @GetMapping("/selectUp/{mentalKnowledgeId}")
//    public String selectUp(@PathVariable("mentalKnowledgeId") Long mentalKnowledgeId,ModelMap mmap)
//    {
//        mmap.put("mentalKnowledgeUp", mentalKnowledgeService.selectUp(mentalKnowledgeId));
//        return "foreground/client/mentalKnowledgeDetails";
//    }
//
//
...
//     * 下一篇
//     */
//    @GetMapping("/selectNext/{mentalKnowledgeId}")
//    public String selectNext(@PathVariable("mentalKnowledgeId") Long mentalKnowledgeId,ModelMap mmap)
//    {
//        mmap.put("mentalKnowledgeNext", mentalKnowledgeService.selectNext(mentalKnowledgeId));
//        return "foreground/client/mentalKnowledgeDetails";
//    }
